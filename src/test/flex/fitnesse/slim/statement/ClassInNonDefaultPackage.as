...
package fitnesse.slim.statement
{
	...
	public class ClassInNonDefaultPackage
	{
		private var calls_ : Dictionary;
		
		public function ClassInNonDefaultPackage()
		{
			calls_ = new Dictionary();
		}
		
		public function table(args : Array) : void
		{
			calls_["table"] = args;	
		}
		
		public function wasCalled(method : String, args : Array) : Boolean
		{
			return (method in calls_);
		}
	}
}