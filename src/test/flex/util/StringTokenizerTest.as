...
package util
{
	...
	{		
		...
		public function itWillHandleCorrectlyEmptyInput() : void
		{
			...
			const ACTUAL   : Array = StringTokenizer.getTokens("");
			
			Assert.assertEquals(EXPECTED.toString(), ACTUAL.toString());
		}
		
		[Test]
		public function itWillHandleCorrectlySingleToken() : void
		{
			const EXPECTED : Array = ["token"];
			const ACTUAL   : Array = StringTokenizer.getTokens("token");
			
			Assert.assertEquals(EXPECTED.toString(), ACTUAL.toString());
		}
		
		[Test]
		public function itWillHandleCorrectlyMultipleTokens() : void
		{
			const EXPECTED : Array = ["t1","t2"];
			const ACTUAL   : Array = StringTokenizer.getTokens("t1 t2");
			
			Assert.assertEquals(EXPECTED.toString(), ACTUAL.toString());
		}
		
		[Test]
		public function itWillHandleCorrectlyEmptyTokens() : void
		{
			const EXPECTED : Array = ["t1","t2"];
			const ACTUAL   : Array = StringTokenizer.getTokens("t1  t2");
		...
		[Test]
		public function itWillHandleCorrectlyNotBlankDelimeter() : void
		{
			//TODO: shall we trim blanks in this case?
			const EXPECTED : Array = ["t1"," t2"];
			const ACTUAL   : Array = StringTokenizer.getTokens("t1, t2",",");
