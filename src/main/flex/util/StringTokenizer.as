...
package util
{
	...
	{
		public static function getTokens(input : String, delimeter : String = " ") : Array
		{
			const tokens : Array = input.split(delimeter);
			
			return tokens.filter(
				function(token : String, index: int, array: Array) : Boolean
				{
