...
package fitnesse.slim.service  
{
	...
	public class SlimServiceContext implements ISlimServiceContext
	{
		public function getExitFunction() : Function
		{
			return NativeApplication.nativeApplication.exit;	
		}
		
		public function getLoggingTarget() : ILoggingTarget
		{
