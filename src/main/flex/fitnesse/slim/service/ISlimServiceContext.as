...
package fitnesse.slim.service
{
	...
	public interface ISlimServiceContext
	{
		//
		//ASMock limitation: read-only properties are not mockable
		//
		function getExitFunction() : Function;
		function getLoggingTarget() : ILoggingTarget;
	}
}