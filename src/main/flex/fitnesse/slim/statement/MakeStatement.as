...
package fitnesse.slim.statement
{
	...
	public class MakeStatement implements IStatement
	{
		private var instance_  : String;
		private var className_ : String;
		private var args_      : Array;
		
		public function MakeStatement(instance : String, className : String, args : Array)
		{
			instance_  = instance;
		...
		{
			return executor.create(instance_, className_, args_);
		}
	}
}