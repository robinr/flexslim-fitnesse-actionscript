...
package util
{
	public class UndefinedCommandLineOptionSuppliedError extends CommandLineError
	{
		public function UndefinedCommandLineOptionSuppliedError(name : String)
		{
			const message : String = "Undefined command line option '-"+name+"' supplied";
