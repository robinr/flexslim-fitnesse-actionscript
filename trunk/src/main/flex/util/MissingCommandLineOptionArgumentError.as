...
package util
{
	public class MissingCommandLineOptionArgumentError extends CommandLineError
	{
		public function MissingCommandLineOptionArgumentError(optName : String, argName : String)
		{
			const message : String = "Command line option '-"+optName+"' argument '"+argName+"' is missing";
			super(message);
		}
	}
}