...
package util
{
	public class UnexpectedCommandLineArgumentError extends CommandLineError
	{
		public function UnexpectedCommandLineArgumentError(args : Array)
		{
			const message : String =
				"Unexpected command line argument(s): " + args.toString();
			super(message);
		}
	}
}