...
package util
{
	public class MissingCommandLineArgumentError extends CommandLineError
	{
		public function MissingCommandLineArgumentError(argName : String)
		{
			const message : String = "Command line argument '"+argName+"' is missing";
			super(message);
		}
	}
}